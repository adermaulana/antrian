        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item position-relative">
              <div class="img">
                <img src="assets/home/img/services-1.jpg" class="img-fluid" alt="">
              </div>
              <div class="details">
                <a href="antrian.php" class="stretched-link">
                  <h3>Ambil Antrian</h3>
                </a>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item position-relative">
              <div class="img">
                <img src="assets/home/img/services-2.jpg" class="img-fluid" alt="">
              </div>
              <div class="details">
      ...
      <div class="container">
        ...
        <div class="row faq-item" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-5 d-flex">
            ...
            <h4>Apa itu sistem antrian bank?</h4>
          </div>
          <div class="col-lg-7">
            <p>
                Sistem antrian bank adalah aplikasi yang membantu mengelola dan memantau giliran pelanggan saat menunggu layanan di bank, memastikan pelayanan lebih teratur dan efisien.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-5 d-flex">
            <i class="bi bi-question-circle"></i>
            <h4>Bagaimana cara mengambil nomor antrian?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            Anda dapat mengambil nomor antrian melalui mesin antrian di bank, aplikasi mobile bank (jika tersedia), atau melalui website resmi bank untuk beberapa cabang yang mendukung layanan online.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-5 d-flex">
            <i class="bi bi-question-circle"></i>
            <h4>Bisakah saya mengambil nomor antrian sebelum datang ke bank?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            Ya, beberapa bank menyediakan fitur untuk mengambil nomor antrian secara online melalui aplikasi mobile atau website, sehingga Anda bisa mengambil nomor dari rumah sebelum datang ke cabang
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row faq-item" data-aos="fade-up" data-aos-delay="400">
          <div class="col-lg-5 d-flex">
            <i class="bi bi-question-circle"></i>
            <h4>Apa yang terjadi jika saya terlambat saat nomor antrian saya dipanggil?</h4>
          </div>
          <div class="col-lg-7">
            <p>
            Jika Anda terlambat dan nomor Anda sudah dipanggil, Anda mungkin diminta untuk mengambil nomor antrian baru atau menunggu sampai ada waktu yang memungkinkan untuk dipanggil kembali.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
